...
def crc64_combine(crc1, crc2, len2):
    _POLY = 0x142F0E1EBA9EA3693
    _XOROUT = 0XFFFFFFFFFFFFFFFF
    combine_fun = mkCombineFun(_POLY, 0, True, _XOROUT)
    return combine_fun(crc1, crc2, len2)
...
# print('crc64_combine:', hash, 318318745347147982, hash == 318318745347147982) # 318318745347147982  0x46ae5365dc3c8ce